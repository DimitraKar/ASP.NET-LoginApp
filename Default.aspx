<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication8.WebForm1" %>
                ...
                <p>                                  
                    ...
                    <div class="form-group row"> 
                           ...
                           <div class="col-sm-9">                            
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="Name" ErrorMessage="Please fill the name!" ForeColor="#c83349" />
                            </div>
                     </div>                                       
                </p>

                <div class="form-group row">
                    <asp:Button runat="server" ID="Register_btn" Text="Register" CssClass="btn btn-lg" OnClick="Register_Click" />
                </div>                                              
            </ContentTemplate>
                
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Register_btn" EventName="Click" />        
            </Triggers>
        </asp:UpdatePanel>
    </form>    
  </div>
